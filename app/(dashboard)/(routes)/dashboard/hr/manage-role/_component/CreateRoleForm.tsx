...
const RoleSchema = z.object({
  ...
  permissions: z.object({
    ...
    manageOnlyPos: z.boolean(),
    dashboard: z.boolean(),
    user: z.boolean(),
    product: z.boolean(),
    sales: z.boolean(),
    purchase: z.boolean(),
    stockTransfer: z.boolean(),
    stockAdjustment: z.boolean(),
    expenses: z.boolean(),
    paymentAccount: z.boolean(),
    report: z.boolean(),
    ...
    listProduct: z.boolean(),
    addProduct: z.boolean(),
    manageProduct: z.boolean(),
    viewProduct: z.boolean(),
    editProduct: z.boolean(),
    deleteProduct: z.boolean(),

    addUnit: z.boolean(),
    manageUnit: z.boolean(),
    viewUnit: z.boolean(),
    editUnit: z.boolean(),
    deleteUnit: z.boolean(),

    addBrand: z.boolean(),
    manageBrand: z.boolean(),
    viewBrand: z.boolean(),
    editBrand: z.boolean(),
    deleteBrand: z.boolean(),

    addCategory: z.boolean(),
    manageCategory: z.boolean(),
    viewCategory: z.boolean(),
    editCategory: z.boolean(),
    deleteCategory: z.boolean(),

    addPrintLabel: z.boolean(),
    managePrintLabel: z.boolean(),
    viewPrintLabel: z.boolean(),

    addVariation: z.boolean(),
    manageVariation: z.boolean(),
    viewVariation: z.boolean(),
    editVariation: z.boolean(),
    deleteVariation: z.boolean(),

    manageImportProduct: z.boolean(),
    addSellingGroupPrice: z.boolean(),
    manageSellingGroupPrice: z.boolean(),
    viewSellingGroupPrice: z.boolean(),
    editSellingGroupPrice: z.boolean(),
    deleteSellingGroupPrice: z.boolean(),

    addWarrant: z.boolean(),
    manageWarrant: z.boolean(),
    viewWarrant: z.boolean(),
    editWarrant: z.boolean(),
    deleteWarrant: z.boolean(),

    manageAllSales: z.boolean(),
    addSales: z.boolean(),
    ...
    addOrder: z.boolean(),
    manageOrder: z.boolean(),
    viewOrder: z.boolean(),
    editOrder: z.boolean(),
    deleteOrder: z.boolean(),
    listOrder: z.boolean(),

    listSellReturn: z.boolean(),

    importSales: z.boolean(),

    listPurchase: z.boolean(),
    addPurchase: z.boolean(),
    managePurchase: z.boolean(),
    viewPurchase: z.boolean(),
    editPurchase: z.boolean(),
    deletePurchase: z.boolean(),

    listPurchaseReturn: z.boolean(),

    importPurchase: z.boolean(),

    listStockTransfer: z.boolean(),
    addStockTransfer: z.boolean(),
    manageStockTransfer: z.boolean(),
    viewStockTransfer: z.boolean(),
    editStockTransfer: z.boolean(),
    deleteStockTransfer: z.boolean(),

    listStockAdjustment: z.boolean(),
    addStockAdjustment: z.boolean(),
    manageStockAdjustment: z.boolean(),
    viewStockAdjustment: z.boolean(),
    editStockAdjustment: z.boolean(),
    deleteStockAdjustment: z.boolean(),

    addExpensesCategory: z.boolean(),
    manageExpensesCategory: z.boolean(),
    viewExpensesCategory: z.boolean(),
    editExpensesCategory: z.boolean(),
    deleteExpensesCategory: z.boolean(),
